...
import io.github.panxiaochao.boot3.web.filter.CorsFilter;
import io.github.panxiaochao.boot3.web.filter.EncodingFilter;
import io.github.panxiaochao.boot3.web.filter.RequestWrapperFilter;
import io.github.panxiaochao.boot3.web.filter.XssFilter;
...
public class FilterAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(name = "spring.pxc-framework-boot3.cors.enabled", havingValue = "true")
     ...
     */
    @Bean
    @ConditionalOnProperty(name = "spring.pxc-framework-boot3.xss.enabled", havingValue = "true")
